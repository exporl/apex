...
//FIXME remove these includes, they are just for testing
                                             ...
                                             QWidget* parent)
{
    ...
    runDelegate = new apex::ExperimentRunDelegate(*experimentData, parent);
    runDelegate->makeModules(0);
