...
class DatabasePrivate
{
    public:
        ...
        {
            return
                soundCard == RMEMULTIFACE_STR ? RmeMultiface :
                soundCard == RMEFIREFACEUC_STR ? RmeFirefaceUc :
                LynxOne;
        }
        ...
        {
            return
                soundCard == RmeMultiface ? RMEMULTIFACE_STR :
                soundCard == RmeFirefaceUc ? RMEFIREFACEUC_STR :
                LYNXONE_STR;
        }
