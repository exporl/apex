...
#ifndef SPINUSERSETTINGS_H
#define SPINUSERSETTINGS_H
...
struct SPIN_EXPORT Info
{
    QString subjectName;
};

struct SPIN_EXPORT Materials
{
...
struct SPIN_EXPORT SpeakerLevels
{
    SpeakerLevels();
...
struct SPIN_EXPORT Calibration
{
    double dBAOfInternalRms;
};

struct SPIN_EXPORT Options
{
    Options();
...
class SPIN_EXPORT SpinUserSettings
{
public:
    SpinUserSettings();
