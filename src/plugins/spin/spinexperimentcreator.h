...
#ifndef SPINEXPERIMENTCREATOR_H
#define SPINEXPERIMENTCREATOR_H
...
class SPIN_EXPORT SpinExperimentCreator
{
    public:
    ...
    private:
        ...
        apex::data::ExperimentData createExperimentData() const;
        apex::data::DatablocksData* createDatablocksData() const;
        apex::data::StimuliData* createStimuliData() const;
        apex::data::ApexProcedureConfig* createProcedureConfig() const;
        ...
        apex::data::FilterData* createNoiseFadeFilter(bool fadein, uint channel) const;
        ...
        apex::data::GeneralParameters* createGeneralParameters() const;
