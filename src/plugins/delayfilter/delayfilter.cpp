...
class DelayFilterCreator : public QObject, public PluginFilterCreator
{
    Q_OBJECT
...
class DelayFilter : public QObject, public PluginFilterInterface
{
    Q_OBJECT
public:
    DelayFilter();
...
DelayFilterCreator::createFilter(const QString &name, unsigned channels,
