#ifndef _APEX_SRC_PLUGINS_APEXPROCEDURES_MULTIPROCEDURE_H_
#define _APEX_SRC_PLUGINS_APEXPROCEDURES_MULTIPROCEDURE_H_
...
#endif // _APEX_SRC_PLUGINS_APEXPROCEDURES_MULTIPROCEDURE_H_
