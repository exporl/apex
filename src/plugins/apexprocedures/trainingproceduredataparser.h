...
#ifndef _EXPORL_SRC_PLUGINS_APEXPROCEDURES_TRAININGPROCEDUREDATAPARSER_H_
#define _EXPORL_SRC_PLUGINS_APEXPROCEDURES_TRAININGPROCEDUREDATAPARSER_H_
...
class TrainingProcedureDataParser:
