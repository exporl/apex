...
LedControllerTest::LedControllerTest() : myDialog(new Ui::Dialog())
{
    ...
    connect(myDialog->button_nightrider, SIGNAL(clicked(bool)), this,
            SLOT(nightRider()));

    connect(myDialog->buttonQuit, SIGNAL(clicked(bool)), this, SLOT(quit()));

    connect(myDialog->buttonClear, SIGNAL(clicked(bool)), this, SLOT(clear()));

    connect(myDialog->buttonRandom, SIGNAL(clicked(bool)), this,
            SLOT(random()));
}
