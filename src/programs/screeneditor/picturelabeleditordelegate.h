...
#ifndef _APEX_SRC_PROGRAMS_SCREENEDITOR_PICTURELABELEDITORDELEGATE_H_
#define _APEX_SRC_PROGRAMS_SCREENEDITOR_PICTURELABELEDITORDELEGATE_H_
 ...
 * PictureLabelElement.
 */
class PictureLabelEditorDelegate : public LabelEditorDelegateBase
{
    Q_OBJECT
...
public:
    PictureLabelEditorDelegate(PictureLabelElement *e, QWidget *parent,
                               ScreenWidget *w);
