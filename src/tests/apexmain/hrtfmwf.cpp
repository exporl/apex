...
const char signalWaveFile[] = "../../../bertha-lib/data/testdata/man001.wav";
const char noiseWaveFile[] = "../../../examples/mwffilter/auditec16000.wav";
const char testWaveFile[] =
    "../../../examples/mwffilter/output_SNR-10_sentence1.wav";
// const char resultWaveFile[] = "result-generated.wav";
...
void ApexMainTest::hrtfMwf_data()
{
