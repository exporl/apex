...
//         qCDebug(APEX_RS, "Datablocks test FAILED");
//     else
//         qCDebug(APEX_RS, "Datablocks test successfull");
...
//         qCDebug(APEX_RS, "Devices test FAILED");
//     else
//         qCDebug(APEX_RS, "Devices test successfull");
...
//         qCDebug(APEX_RS, "Procedures test FAILED");
//     else
//         qCDebug(APEX_RS, "Procedures test successfull");
...
//         qCDebug(APEX_RS, "Filters test FAILED");
//     else
//         qCDebug(APEX_RS, "Filters test successfull");
...
//         qCDebug(APEX_RS, "Screens test FAILED");
//     else
//         qCDebug(APEX_RS, "Screens test successfull");
...
//         qCDebug(APEX_RS, "Stimuli test FAILED");
//     else
//         qCDebug(APEX_RS, "Stimuli test successfull");
//     /*---end test for stimuli---*/
    ...
    if (!t.Test(expDirs))
        qCDebug(APEX_RS, "Experiment test FAILED");
    else
        qCDebug(APEX_RS, "Experiment test successfull");
