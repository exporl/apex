...
ArcLayoutEditorDelegate::ArcLayoutEditorDelegate(
    ArcLayoutElement* e, QWidget* parent,
...
QVariant ArcLayoutEditorDelegate::getPropertyData( int nr, int role )
{
    ...
    case 1: // type
        if ( role == Qt::DisplayRole )
        {
            ...
            {
            case ArcLayout::ARC_TOP: return QString::fromUtf8( "Upper" );
            case ArcLayout::ARC_BOTTOM: return QString::fromUtf8( "Lower" );
            case ArcLayout::ARC_LEFT: return QString::fromUtf8( "Left" );
            case ArcLayout::ARC_RIGHT: return QString::fromUtf8( "Right" );
            case ArcLayout::ARC_FULL: return QString::fromUtf8( "Full" );
            }
        }
    default:
        return QVariant();
...
void ArcLayoutEditorDelegate::updateLayout( elementToDelegateMapT& elementToDelegateMap )
{
