...
DatablockDataPrivate::DatablockDataPrivate()
    : nbChannels(0), nbLoops(1), gain(0.0)
{
}

bool DatablockDataPrivate::operator==(const DatablockDataPrivate &other) const
{
    return gain == other.gain && nbLoops == other.nbLoops &&
           nbChannels == other.nbChannels && device == other.device &&
           description == other.description && prefix == other.prefix &&
           id == other.id && file == other.file &&
