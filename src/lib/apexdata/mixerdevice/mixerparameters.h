...
#ifndef _EXPORL_SRC_LIB_APEXDATA_MIXERDEVICE_MIXERPARAMETERS_H_
#define _EXPORL_SRC_LIB_APEXDATA_MIXERDEVICE_MIXERPARAMETERS_H_
...
#endif //#ifndef _EXPORL_SRC_LIB_APEXDATA_MIXERDEVICE_MIXERPARAMETERS_H_
