...
ButtonGroup::const_iterator::const_iterator(
    const QList<QString>::const_iterator &it)
{
    *this = it;
}
...
apex::data::ButtonGroup::ButtonGroup(const QString &ac_sID) : id(ac_sID)
{
}
...
bool apex::data::ButtonGroup::
operator==(const apex::data::ButtonGroup &other) const
{
    if (size() != other.size())
        return false;
