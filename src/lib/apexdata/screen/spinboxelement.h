 ...
 */
class APEXDATA_EXPORT SpinBoxElement
            : public ScreenElement
{
    public:
        ...
        void SetStep(const float p) { step=p; };
        float GetStep() const { return step; };
        void SetValue(const float p) { value=p; hasDefault=true; };
        float GetValue() const { return value; };
        bool HasDefault() const { return hasDefault; };
        bool GetReset() const { return reset; };
        void SetReset(const bool p) { reset=p; };

        void SetParameter(const QString p) { parameter=p; };
