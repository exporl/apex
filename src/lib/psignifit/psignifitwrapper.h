#ifndef _EXPORL_SRC_LIB_PSIGNIFIT_PSIGNIFITWRAPPER_H_
#define _EXPORL_SRC_LIB_PSIGNIFIT_PSIGNIFITWRAPPER_H_
...
class PSIGNIFIT_EXPORT PsignifitResult:
        public QObject
{
    Q_OBJECT
    ...
    Q_PROPERTY(ListMatrix thresholdsLims READ thresholdsLims WRITE setThresholdsLims)
