...
Compare::mt_eResult Compare::sf_eCompareWave( const std::string& ac_sFile0, const std::string& ac_sFile1 ) throw()
{
  try
  {
    InputWaveFile fin0;
...
Compare::mt_eResult Compare::sf_eCompareWave( const Compare::mt_Files& ac_sFile0, const std::string& ac_sFile1 ) throw()
{
  try
  {
