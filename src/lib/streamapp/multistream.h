...
/**
  ...
  *   malloc et all, so it's wise to add everything before your app is
  *streaming.
  *   @see InputStream
...
class MultiInputStream : public InputStream,
                         public DynStreamList<InputStream, tOwned>
{
public:
    /**
      * Constructor.
...
/**
  ...
  ********************************************** */
template <bool tOwned = true>
class MultiPosInputStream
    : public PositionableInputStream,
      public DynStreamList<PositionableInputStream, tOwned>
{
public:
    /**
      * Constructor.
...
/**
  ...
  *   =>Final stream = 3 ( 1 + 2 ) channel, Write()'s input should be >=3
  *channels
  ...
  */
template <bool tOwned = true>
class MultiOutputStream : public OutputStream,
                          public DynStreamList<OutputStream, tOwned>
{
public:
    /**
      * Constructor.
