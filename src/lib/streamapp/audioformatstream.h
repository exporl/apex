...
namespace streamapp
{
  ...
  public:
    ...
    virtual const Stream& Read();
      ...
      /**
        ...
        * @param ac_bDeleteReader if true, deletes ac_pSource upon destruction or replacing reader
        */
    void mp_ReplaceReader( AudioFormatReader* const ac_pSource, const bool ac_bDeleteReader = false );
  ...
  private:
    ...
    /**
      ...
      *   used to transform a PositionableAudioFormatReader into a PositionableInputStream.
      *   Every Read() call reads ac_nBufferSize samples from the source, when the source
      *   is exhausted, zeros are added, unless the number of loops is > 1.
      *   When looping, and the end of the reader's position is reached, the read position
      *   is reset to 0 and everything starts all over again, except when number of loops
      *   becomes equal to the number of loops set by mp_SetNumLoops: then zeroes are added
  ...
  public:
    ...
    bool mf_bIsLooping() const;
      ...
      /**
        ...
        */
    void mp_ReplaceReader( PositionableAudioFormatReader* const ac_pSource, const bool ac_bDeleteReader );
  ...
  public:
    ...
    virtual void Write( const Stream& ac_Stream );
      ...
      /**
        ...
        * @param ac_bDeleteWriter if true, deletes ac_pSink upon destruction or replacing writer
        */
    void mp_ReplaceWriter( AudioFormatWriter* const ac_pSink, const bool ac_bDeleteWriter );
