...
namespace appcore
{
  ...
  public:
      /**
        ...
        * this will set the actual thread name via the kernel API, which is nice for debugging.
        */
    ...
    INLINE bool mf_bThreadShouldStop() const
    {
      ...
      /**
        ...
        * @param ac_nTimeoutInMSec the time to wait, in milliseconds; -1 means forever
    ...
    void mp_SetPriority( const IThread::mt_ePriority ac_Priority );
      ...
      /**
        ...
        * @param ac_Priority the new priority
        */
    static void sf_SetCurrentThreadPriority( const IThread::mt_ePriority ac_Priority );
      ...
      /**
        ...
        * @param ac_nTimeoutInMSec the time to wait, in milliseconds; -1 means forever
        * @return true if the event has been signalled, or false if the timeout expires.
        */
