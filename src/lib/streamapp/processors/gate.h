...
namespace streamapp
{
  ...
  public:
    ...
    typedef double (*mt_FadeFunc)( const double& ac_dCurSample, const double& ac_dFadeLength );
      ...
      /**
        ...
        */
    Gate( const unsigned ac_nChan, const unsigned ac_nSize, mt_FadeFunc a_pfnFunc );
  ...
  struct tFadeFunc
  {
      /**
        ...
        */
    static double smf_dLinearFadeIn( const double& ac_dCurSample, const double& ac_dFadeLength )
    {
      return ac_dCurSample / ac_dFadeLength;
    }
      ...
      /**
        ...
        */
    static double smf_dCosineFadeIn( const double& ac_dCurSample, const double& ac_dFadeLength )
    {
      ...
      /**
        ...
        */
    static double smf_dLinearFadeOut( const double& ac_dCurSample, const double& ac_dFadeLength )
    {
      return 1.0 - ( ac_dCurSample / ac_dFadeLength );
    }
      ...
      /**
        ...
        * @param ac_dCurSample sample position
        * @param ac_dFadeLength total fade length
        * @return 0.5 * ( 1.0 - cos( pi * ( ac_dCurSample - ac_dFadeLength ) / ac_dFadeLength ) )
        */
