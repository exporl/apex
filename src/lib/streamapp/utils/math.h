...
/**
  ...
  */
INLINE void gf_QuotRem(int numerator, int denominator, int *quotient,
                       int *remainder)
{
...
INLINE void gf_QuotRem(unsigned numerator, unsigned denominator,
...
tType gf_RoundToMultiple(const tType ac_nToRound, const tType ac_nMultiple,
                         const bool ac_bUp)
{
