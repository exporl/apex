...
public:
    ...
    /**
      ...
      */
    enum AudioFormat::mt_eBitMode { MSBshort12, MSBshort14, MSBshort16 };
#else
    /**
...
public:
    ...
    /**
      ...
      */
    virtual unsigned long Write(const void **a_pBuf,
                                const unsigned ac_nSamples) = 0;
};
...
protected:
    /**
      * Potected Constructor.
      */
    PositionableAudioFormatReader() : mv_lLoopStart(0L), mv_lLoopEnd(0L)
    {
    }
