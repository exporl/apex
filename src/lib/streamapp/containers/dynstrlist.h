...
public:
    ...
    /**
      * Constructor.
      */
    DynStreamList() : tArray(3), mv_nChan(0), mv_nSize(0)
    {
    }
    ...
    /**
      ...
      */
    INLINE virtual const tInOrOutStream *
    mf_pGetItem(const unsigned ac_nItemPos) const
    {
...
protected:
    /**
      ...
      * Implementations should override this method, and update their pointer
     * memory
