...
namespace streamapp
{
  ...
  tType* f_InitDynMem(  const unsigned ac_nSize,
                        const bool     ac_bInit  )
  {
    if( ac_nSize != 0 )
    {
  ...
  public:
      /**
        ...
        */
    DynamicArray( const unsigned ac_nInitSize = 0, const unsigned ac_nGrowSize = 2 ) :
    ...
    INLINE bool mf_bIsEmpty() const
    {
      ...
      /**
        ...
        */
    int mf_nGetItemIndex( const tType a_ItemToSearch, const unsigned ac_nSearchOffset = 0 ) const
    {
