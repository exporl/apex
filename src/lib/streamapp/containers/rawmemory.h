  ...
  public:
    ...
    RawMemoryAccess();
      ...
      /**
        ...
        */
    RawMemoryAccess( void* const ac_pMemory, const unsigned ac_nSize, const bool ac_bInitToZero = false );
    ...
    INLINE const unsigned& mf_nGetSize() const
    {
      ...
      /**
        ...
        */
    void mp_CopyFrom( const void* const ac_pToCopy, const unsigned ac_nDestOffset, const unsigned ac_nSize );
      ...
      /**
        ...
        * @param ac_nSize the size to copy
        */
    void mf_CopyTo( void* const ac_pToCopy, const unsigned ac_nSourceOffset, const unsigned ac_nSize ) const;
  ...
  public:
    ...
    ~RawMemory();
      ...
      /**
        ...
        * @param ac_bInitToZero if true, sets al content to 0
        */
    RawMemory( const unsigned ac_nInitialSize, const bool ac_bInitToZero = false );
    ...
    RawMemory& operator = ( const RawMemoryAccess& ac_Rh );
      ...
      /**
        ...
        */
    RawMemoryAccess mf_GetAccess( const unsigned ac_nStartOffSet, const unsigned ac_nLength );

      /**
        * Resize the memory.
        * ac_bInitToZero has only effect if the new size is bigger then the current size.
        * @param ac_nNewSize the new size
        * @param ac_bInitToZero if true, initializes newly allocated part to 0
        */
    void mp_Resize( const unsigned ac_nNewSize, const bool ac_bInitToZero = false );
      ...
      /**
        ...
        * @param ac_bInitToZero  if true, initializes newly allocated part to 0
        */
    void mp_ResizeIfSmaller( const unsigned ac_nNewSize, const bool ac_bInitToZero = false );
    ...
    void mp_RemovePart( const unsigned ac_nStartOffset, const unsigned ac_nSize );
      ...
      /**
        ...
        */
    void mp_ShiftDown( const unsigned ac_nStartOffset, const unsigned ac_nSize, const bool ac_bClear = true );
