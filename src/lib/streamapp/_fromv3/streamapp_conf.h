...
/**
  ...
  * Use only if you're sure what you're doing: when defining this and at the
 * same time
  * using a custom allocator, if you @c new something, it's memory will not come
 * from
  * your custom allocator. This isn't necessarily a bad thing, but it leads to a
 * weird
  * allocation policy.
  */
#ifndef S_NO_GLOBAL_OPERATOR_OVERLOAD
