...
namespace types
{
  ...
  struct tPointerTraits
  {
    ...
    typedef typename mpl::tIf< mt_IsPointer::value, mt_Pointer2Pointer, mt_Pointer >::type tIntPtr;
    ...
    typedef const tType*  tExtCPtr;
      ...
      /**
        ...
        */
    s_finline static void smf_MemCpy( mt_Pointer& a_pDest, tExtCPtr ac_pSrc, const size_type ac_nElements )
    {
      ...
      /**
        ...
        * @param ac_nElements number of elements (NOT bytes)
        */
    s_finline static void smf_MemCpy( mt_Pointer2Pointer& a_pDest, tExtCPtr ac_pSrc, const size_type ac_nElements )
    {
      typedef typename types::tRemovePointer< tType >::type tPointedTo;
      s_static_assert( !types::tIsPointer< tPointedTo >::value, PointerToPOinterToPOinterIsNotAllowed );
