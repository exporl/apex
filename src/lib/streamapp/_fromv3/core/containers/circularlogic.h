...
namespace containers
{
  ...
  public:
      ...
      mc_Lock()
    {
      Q_ASSERT( a_pBegin );
      Q_ASSERT( ac_nLength );
      s_static_assert( ( tIsPointer::value == false ), YouGotTheWrongConstructor );
    }
      ...
      /**
        ...
        */
    CircularLogic( tPtr a_pBegin, const size_type ac_nLength, const size_type ac_nChannels ) :
    ...
    s_finline void mp_WritePiece( size_type& a_nWritten )
    {
      ...
      /**
        ...
        */
    s_finline void mp_WritePiece( size_type& a_nWritten, const size_type ac_nMaxToMove )
    {
    ...
    s_finline void mp_WritePiece( size_type& a_nWritten, tPtr& a_pPreviousPos )
    {
      ...
      /**
        ...
        * @param ac_nMaxToMove maximum moves
        */
    s_finline void mp_WritePiece( size_type& a_nWritten, tPtr& a_pPreviousPos, const size_type ac_nMaxToMove )
    {
      mp_WritePieceInt( a_nWritten, this->m_pTempW, ac_nMaxToMove );
    ...
    s_finline void mp_ReadPiece( size_type& a_nRead )
    {
      ...
      /**
        ...
        */
    s_finline void mp_ReadPiece( size_type& a_nRead, const size_type ac_nMaxToMove )
    {
    ...
    s_finline void mp_ReadPiece( size_type& a_nRead, tCPtr& a_pPreviousPos )
    {
      ...
      /**
        ...
        * @param ac_nMaxToRead maximum moves
        */
    s_finline void mp_ReadPiece( size_type& a_nRead, tCPtr& a_pPreviousPos, const size_type ac_nMaxToMove )
    {
      mp_ReadPieceInt( a_nRead, this->m_pTempR, ac_nMaxToMove );
      ...
      /**
        ...
        */
    void mp_Write( tCPtr ac_pSource, size_type& a_nWritten, const size_type ac_nMaxToWrite )
    {
      a_nWritten = 0;
      size_type nPiece = 1;
      ...
      {
        nPiece = mf_nGetPiece( this->m_pWrite, this->m_pRead, ac_nMaxToWrite - a_nWritten, false );
        if( nPiece )
        {
          mt_Parent::tTraits::smf_MemCpy( this->m_pWrite, this->m_pTempW, nPiece );
          a_nWritten += nPiece;
      ...
      /**
        ...
        */
    void mp_Read( tPtr a_pDest, size_type& a_nRead, const size_type ac_nMaxToRead )
    {
      a_nRead = 0;
      size_type nPiece = 1;
      ...
      {
        nPiece = mf_nGetPiece( this->m_pRead, this->m_pWrite, ac_nMaxToRead - a_nRead, true );
        if( nPiece )
        {
          mt_Parent::tTraits::smf_MemCpy( this->m_pTempR, this->m_pRead, nPiece );
          a_nRead += nPiece;
    ...
    void mp_Read( size_type& a_nRead, const size_type ac_nMaxToRead )
    {
      ...
      /**
        ...
        */
    void mp_Read2Dto1D( tType a_pDest, size_type& a_nRead, const size_type ac_nMaxToRead )
    {
      ...
      /**
        ...
        */
    template< class tOp >
    void mp_Write( tOp& a_Writer, size_type& a_nWritten, const size_type ac_nMaxToWrite )
    {
      a_nWritten = 0;
      size_type nPiece = 1;
      while( nPiece && a_nWritten < ac_nMaxToWrite )
      ...
      /**
        ...
        */
    template< class tOp >
    void mp_Read( tOp& a_Reader, size_type& a_nRead, const size_type ac_nMaxToRead )
    {
      a_nRead = 0;
      size_type nPiece = 1;
      while( nPiece && a_nRead < ac_nMaxToRead )
    ...
    bool mp_bReadUpTo( const tType& ac_tSearch, size_type& a_nRead )
    {
      ...
      while( nPiece )
      {
        nPiece = mf_nGetPiece( this->m_pRead, this->m_pWrite, mc_nSize - a_nRead, true );
        size_type nWhere = 0;
        while( nWhere < nPiece )
        {
...
#ifdef S_SPEC_PRINT
    friend struct tCircularLogicSpecPrinter< tType, tIsPointer::value, tCriticalSection >;
    ...
    {
      tCircularLogicSpecPrinter< tType, tIsPointer::value, tCriticalSection >()( *this );
    }
  ...
  private:
      /**
        ...
        * @param ac_nMaxToMove maximum moves
        */
    void mp_WritePieceInt( size_type& a_nWritten, tIPtr& a_pPreviousPos, const size_type ac_nMaxToMove )
    {
      a_pPreviousPos = this->m_pWrite;
      a_nWritten = mf_nGetPiece( this->m_pWrite, this->m_pRead, ac_nMaxToMove, false );
      ...
      /**
        ...
        * @param ac_nMaxToRead maximum moves
        */
    void mp_ReadPieceInt( size_type& a_nRead, tIPtr& a_pPreviousPos, const size_type ac_nMaxToMove )
    {
      a_pPreviousPos = this->m_pRead;
      a_nRead = mf_nGetPiece( this->m_pRead, this->m_pWrite, ac_nMaxToMove, true );
      ...
      /**
        ...
        */
    size_type mf_nGetPiece( const tIPtr& ac_pStartAt, const tIPtr& ac_pStopAt, const size_type ac_nRequested, const bool ac_bIsReadPtr )
    {
      size_type nMoved = 0;
      const mt_Lock L( mc_Lock );
      if( ac_pStopAt > ac_pStartAt )
      {
        const size_type nDiff = (size_type) ( ac_pStopAt - ac_pStartAt ); //avoid calculating twice in s_min.. FIXME template
      ...
      /**
        ...
        * @param ac_bIsReadPtr true if it's m_pRead
        */
    void mp_Move( tIPtr& a_pToMove, const size_type ac_nToMove, const bool ac_bIsReadPtr )
    {
      const mt_Lock L( mc_Lock );
  ...
  struct tCircularLogicSpecPrinter
  {
    void operator()( const CircularLogic< tType, tCriticalSection >& ac_ToPrint ) const s_no_throw
    {
