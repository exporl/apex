...
/**
  ...
  *   Maybe it was his intention: there's also a missing semicolon in his
 * example.
  *   Anyway, when used like this:
  *   @code
  *   void testAssert()
  *   {
  *     s_static_assert( sizeof( char ) == sizeof( double ),
 * CompilerWillComplainHere )
  *   }
  *   @endcode
  *   the compiler will generate something like
  *   @verbatim
  *   cannot convert from 'testAssert::Error_StaticAssertionFailed' to
 * 'theAssert<false>'
  *   @endverbatim
  *   since it cannot convert from Error_StaticAssertionFailed to
 * theAssert<false>.
  *   Because everything is done by the compiler, no instructions will be
 * generated
