...
/**
  ...
  * the bytes needed to do exactly the same, unless we'd be using Chinese text
 * or so.
  */
...
/**
  ...
  */
s_dll bool gf_bStringStartsWith(const s_wchar *ac_pwsSearch,
...
/**
  ...
  */
s_dll void gf_InStringCopy(s_wchar *a_pwsStringStart,
...
s_dll bool gf_bWCharToChar( const s_wchar* ac_pwsSrc, String& a_sDest )
s_no_throw;*/
...
/**
  ...
  * @return false if source contains chars that cannot be represented
  */
s_dll bool gf_bWCharToChar(const s_wchar *ac_pwsSrc,
...
/**
  ...
  * @return false if source contains chars that cannot be represented
  */
s_dll bool gf_bCharToWChar(const char *ac_psSrc,
