...
bool wchars::gf_bStringStartsWith( const s_wchar* ac_pwsSearch, const char* ac_psFind, size_t& a_nLen ) s_no_throw
{
  if( !a_nLen )
...
void wchars::gf_InStringCopy( s_wchar* a_pwsStringStart, const size_t ac_nStartOffset, const size_t ac_nStopOffset ) s_no_throw
{
...
/*bool wchars::gf_bWCharToChar( const s_wchar* ac_pwsSrc, String& a_sDest ) s_no_throw
{
...
bool wchars::gf_bWCharToChar( const s_wchar* ac_pwsSrc, char*& a_psDest ) s_no_throw
{
  const size_t nLen = gf_Length( ac_pwsSrc );
...
bool wchars::gf_bCharToWChar( const char* ac_sSrc, s_wchar*& a_pwsDest ) s_no_throw
{
  if( a_pwsDest )
    return false;
