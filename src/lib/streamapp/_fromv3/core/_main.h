...
#include "core/memory/new.h"
  ...
  //the macro is there so that the basic headers itself can just include _main.h,
  //instead of having to include config, platform setup and OS headers themselves
#ifndef S_NOBASIC_INCLUDE

  #include "core/memory/memory.h"       //links in the allocation methods
  #include "core/misc/tracermacros.h"   //makes sure the printing macros can be used
