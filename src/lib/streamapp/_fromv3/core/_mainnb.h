...
/**
  ...
  */
  ...
  /**
    ...
    * Prevents the files from including themselves, which is no real problem an sich,
    * but it leads to eg string.h not being able to get the definitions in memory.h.
    */
