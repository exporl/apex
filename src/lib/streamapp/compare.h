...
struct Compare {
    ...
    /**
      ...
      */
    static mt_eResult sf_eCompare(AudioFormatReader &a_Input0,
    ...
    /**
      ...
      * @return true if identical
      */
    static mt_eResult sf_eCompare(mt_Readers &a_Input0,
                                  AudioFormatReader &a_Input1) throw();
    ...
    /**
      ...
      */
    static mt_eResult sf_eCompareWave(const QString &ac_sFile0,
    ...
    /**
      ...
      * @return true if identical data (samplerate is ignored though)
      */
    static mt_eResult sf_eCompareWave(const mt_Files &ac_sFile0,
                                      const QString &ac_sFile1) throw();
