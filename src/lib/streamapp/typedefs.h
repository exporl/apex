 ...
 */
#ifndef _APEX_SRC_LIB_STREAMAPP_TYPEDEFS_H__
#define _APEX_SRC_LIB_STREAMAPP_TYPEDEFS_H__
...
const QString sc_sDefault = QString::fromUtf8("default"); //!< "default" string
const QString sc_sFromGUI =
    QString::fromUtf8("interactive"); //!< "interactive" string
...
const unsigned long sc_lInfinite =
    0xFFFFFFFF; //!< "infinite" for 32 bit unsigned long
}

#endif //#ifndef _APEX_SRC_LIB_STREAMAPP_TYPEDEFS_H__
