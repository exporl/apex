...
#ifndef _EXPORL_SRC_LIB_APEXMAIN_WAVSTIMULUS_MIXERCALLBACK_H_
#define _EXPORL_SRC_LIB_APEXMAIN_WAVSTIMULUS_MIXERCALLBACK_H_
...
/**
  ...
  *     ch0 -> ch0  //stream 2
  *
  *     output channel      mixer inputchannel    mixer
  *outputchannel(==OutputStream input channel)
  *                                                     0     1
  *           0           ->          0               gain  mute
  *           1           ->          1               mute  gain
  *           0           ->          2               mute  gain
...
protected:
    /**
      ...
      */
    IApexMixerCallback(const unsigned ac_nMaxNumInputs,
...
public:
    /**
      ...
      */
    ApexOutputCallback(OutputStream *const ac_pOutput,
                       const unsigned ac_nMaxNumInputs,
                       const bool ac_bDeleteOutput = true);
...
public:
    /**
      ...
      * @param ac_nMaxNumInputs number of mixer inputs.
      */
    ApexProcessorCallback(IStreamProcessor *const ac_pProc,
                          const unsigned ac_nMaxNumInputs);
    ...
    /**
      * Implementation of the StreamCallback method.
      * This will set the StreamCallback::mc_pResult to the IStreamProcessor
     * result.
      */
    void mf_CallbackFunc();
...
#endif //#ifndef _EXPORL_SRC_LIB_APEXMAIN_WAVSTIMULUS_MIXERCALLBACK_H_
