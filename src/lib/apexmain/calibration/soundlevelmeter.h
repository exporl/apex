...
/*SoundLevelMeter.h
*Author: Pieter Verlinde
*Last modified: 17/12/1007
*/
...
public:
	...
	virtual const QStringList transducers() const=0;
	virtual bool setTransducer(QString)=0;
	virtual const QStringList instruments() const=0;
	virtual bool setInstrument(QString)=0;
	virtual bool startMeasurement(int type_measurement,int frequency_weighting,int time_weighting,double percentile=0)=0;
	virtual bool stopMeasurement()=0;
	virtual bool measure(int type_measurement,int frequency_weighting,int time_weighting)=0;
	virtual bool measure(QString)=0;
