...
namespace apex
{
  ...
  namespace rundelegates
  {
    ...
    /**
     * \class ScreenElementRunDelegate ScreenElementRunDelegate.h rundelegates/ScreenElementRunDelegate.h
     *
    ...
    public:
       ...
       * A disabled element must not respond to user interaction when it's disabled,
       * but is allowed to signal this by eg switching to a different color or style.
      ...
      /**
       * Text content.
       * Elements displaying text or allowing to enter text should return true here.
