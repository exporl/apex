...
ApexConstantProcedureParametersParser::ApexConstantProcedureParametersParser()
{
}

void ApexConstantProcedureParametersParser::Parse(XERCES_CPP_NAMESPACE::DOMElement* p_base,
           data::ApexConstantProcedureParameters* p_parameters)
{
    ApexProcedureParametersParser::Parse(p_base, p_parameters);
}

bool ApexConstantProcedureParametersParser::SetParameter(const QString p_name,
