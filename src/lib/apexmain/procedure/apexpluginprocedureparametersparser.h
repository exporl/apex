...
#ifndef ApexPluginProcedureParametersParserH
#define ApexPluginProcedureParametersParserH
            ...
            public ApexProcedureParametersParser
{
    public:
        ...
        ApexPluginProcedureParametersParser();

        virtual ~ApexPluginProcedureParametersParser() {};
