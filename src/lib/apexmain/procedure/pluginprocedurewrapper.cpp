...
const QString PluginProcedureWrapper::INSTANCENAME("pLuGiNiNtErFaCe");

  QScriptValue PluginProcedureWrapper::executeLine(const QString& line, const QScriptValueList& params) const {
