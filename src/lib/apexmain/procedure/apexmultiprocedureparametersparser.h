...
#ifndef ApexMultiProcedureParametersParserH
#define ApexMultiProcedureParametersParserH
...
namespace data
{
class ApexMultiProcedureParameters;
}
namespace parser
{

class ApexMultiProcedureParametersParser:
            public ApexProcedureParametersParser
{
    public:

        ApexMultiProcedureParametersParser();

        virtual ~ApexMultiProcedureParametersParser() {};
