...
namespace apex{
      ...
      //!Everything created by IDeviceFactory   //FIXME all factories must derive from Factory
  class APEX_EXPORT IDeviceFactoryElement : public FactoryElement
    {
    public:
      IDeviceFactoryElement()
      {}
