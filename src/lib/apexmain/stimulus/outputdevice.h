  ...
  namespace stimulus{
    ...
    struct tConnection;
      ...
      /**
        ...
        ******************************************************** */
    class OutputDevice : public device::IApexDevice, public IDeviceFactoryElement
    {
    protected:
        /**
          * Constructor.
    ...
    public:
      ...
      virtual bool AllDone() = 0;
        ...
        /**
          * The identifier of the factory used to create this device.
          * @retrun text string
          */
      virtual const QString& GetModule() const = 0;
