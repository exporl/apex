...
#ifndef __APEXSEQSTREAM_H__
#define __APEXSEQSTREAM_H__
  ...
  namespace stimulus
  {
    ...
    public:
        /**
          ...
          */
      ApexSeqStream( PosAudioFormatStream* a_pParent, const bool ac_bDeleteParent = false );
...
#endif //#ifndef __APEXSEQSTREAM_H__
