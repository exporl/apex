  ...
  namespace gui
  {
    ...
    public:
        /**
          ...
          */
      ApexProgressBar( QWidget* a_pParent ):
        QProgressBar( a_pParent )
      {
        QProgressBar::reset();
      }
    ...
    protected:
      ...
      virtual bool setIndicator( QString& indicator, int progress, int totalSteps )
      {
        if( progress == 0 && totalSteps == 0 )
          ...
          indicator = QString::number( progress ) + " / " + QString::number( totalSteps );
    ...
    public:
        /**
          ...
          * @param a_pParent the parent widget
          */
      ApexStatusWindow( QWidget* a_pParent ) :
        QListWidget( a_pParent )
      {
...
//        ensureCurrentVisible();
    ...
    public:
         ...
         * @param nOkFilename idem for negative feedbadck
          */
        ApexFeedbackPicture( QWidget* a_pParent,
                             QString okFilename,
                             QString nOkFilename );
    ...
    class StatusPicture : public QLabel
    {
        ...
        public:
            StatusPicture( QWidget* a_pParent,
