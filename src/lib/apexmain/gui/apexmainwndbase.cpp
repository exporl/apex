    ...
    : QMainWindow(parent)
{
    ...
    helpDeletePluginCacheAction =
        new QAction("helpDeletePluginCacheAction", this);
    helpShowPluginDialogAction =
        new QAction("helpShowPluginDialogAction", this);
    ...
    hardwareSetupMenu = new QMenu(tr("&Hardware setup"), calibrateMenu);
    ...
    connect(fileOpenAction, SIGNAL(triggered()), this, SIGNAL(fileOpen()));
    connect(startPluginRunnerAction, SIGNAL(triggered()), this,
            SIGNAL(startPluginRunner()));
    connect(selectSoundcardAction, SIGNAL(triggered()), this,
            SIGNAL(selectSoundcard()));
    connect(fileSaveAsAction, SIGNAL(triggered()), this, SIGNAL(fileSaveAs()));
    connect(fileExitAction, SIGNAL(triggered()), this, SIGNAL(fileExit()));
    connect(saveExperimentAction, SIGNAL(triggered()), this,
            SIGNAL(saveExperiment()));
    connect(experimentStopAction, SIGNAL(triggered()), this,
            SIGNAL(stopClicked()));
    connect(experimentStartAction, SIGNAL(triggered()), this,
            SIGNAL(startClicked()));
    connect(experimentPauseAction, SIGNAL(triggered()), this,
            SIGNAL(pauseClicked()));
    connect(experimentShowStimulusAction, SIGNAL(triggered()), this,
            SIGNAL(showStimulus()));
    connect(stimulusRepeatAction, SIGNAL(triggered()), this,
            SIGNAL(repeatTrial()));
    connect(experimentAutoAnswerAction, SIGNAL(triggered()), this,
            SIGNAL(autoAnswerClicked()));
    connect(experimentSkipAction, SIGNAL(triggered()), this,
            SIGNAL(skipClicked()));
    connect(recalibrateAction, SIGNAL(triggered()), this,
            SIGNAL(recalibrateClicked()));
    connect(helpContentsAction, SIGNAL(triggered()), this,
            SLOT(helpContents()));
    connect(helpDeletePluginCacheAction, SIGNAL(triggered()), this,
            SLOT(helpDeletePluginCache()));
    connect(helpEditApexconfigAction, SIGNAL(triggered()), this,
            SLOT(helpEditApexconfig()));
    connect(helpShowPluginDialogAction, SIGNAL(triggered()), this,
            SLOT(helpShowPluginDialog()));
