...
#ifndef APEXPARAMETERSPARSERH
#define APEXPARAMETERSPARSERH
...
class ApexParametersParser: public Parser
{
    public:

    ApexParametersParser();
    ...
    protected:
    virtual bool SetParameter(const QString tag, const QString id, const QString value , XERCES_CPP_NAMESPACE::DOMElement* node) =0;


    data::ApexParameters* currentParameters;
};
