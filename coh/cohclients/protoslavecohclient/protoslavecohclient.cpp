...
{
    return QStringList()
           << QL1S("nic: l34-cic3-1") << QL1S("nic: l34-cic4-1")
           << QL1S("nic: l34-0")
           << QL1S("nic4: implant=CIC4,latency_ms=200,mode=MP1+2,go_live=on")
           << QL1S("nic4: implant=CIC4,latency_ms=200,mode=MP1+2,go_live=off")
