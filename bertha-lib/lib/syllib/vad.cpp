...
VoiceActivityDetector::VoiceActivityDetector(unsigned length, bool synchronous)
...
VoiceActivityDetector::VoiceActivityDetector(const VoiceActivityDetector &other)
    : d(other.d)
{
}

VoiceActivityDetector &VoiceActivityDetector::
operator=(const VoiceActivityDetector &other)
{
    d = other.d;
    return *this;
}
