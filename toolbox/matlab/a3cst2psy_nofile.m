function [stimlabels, percent, count, totals]=a3cst2psy(stimuli,buttons,corrector, spattern, correctanswer)
% this function does the same as a3cst2psy, but accepts  stimuli, buttons
% and corrector as parameters instead of filename
