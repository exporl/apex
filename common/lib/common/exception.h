...
#ifndef _EXPORL_COMMON_LIB_COMMON_EXCEPTION_H_
#define _EXPORL_COMMON_LIB_COMMON_EXCEPTION_H_
 ...
 * marked with RBACONTROL_EXPORT, otherwise exceptions will just terminate()!
 */
